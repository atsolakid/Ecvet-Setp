...
function ecvetstep_custom_header_setup() {
	$args = array(
		...
		'wp-head-callback'       => 'ecvetstep_header_style',
		'admin-head-callback'    => 'ecvetstep_admin_header_style',
		'admin-preview-callback' => 'ecvetstep_header_image',
	);
	...
	register_default_headers( array(
		'defaultlogo' => array(
			...
			'description' => __( 'Default Logo', 'ecvetstep' )
		),
		'ecvetsteplogo' => array(
			'url' => '%s/images/ecvetstep.png',
			'thumbnail_url' => '%s/images/ecvetstep.png',
			/* translators: header image description */
			'description' => __( 'ECVET STEP Logo', 'ecvetstep' )
		)
	) );	
 
}
add_action( 'after_setup_theme', 'ecvetstep_custom_header_setup' );
...
if ( ! function_exists( 'ecvetstep_header_style' ) ) :
/**
...
endif; // ecvetstep_header_style


if ( ! function_exists( 'ecvetstep_admin_header_style' ) ) :
/**
...
endif; // ecvetstep_admin_header_style


if ( ! function_exists( 'ecvetstep_header_image' ) ) :
/**
...
function ecvetstep_header_image() { 	
	...
	<div id="header-left">
		...
		echo $ecvetstep_header_logo;
		echo $ecvetstep_header_details;
		   
		?>
        
	</div><!-- #header-left"> -->
<?php }
endif; // ecvetstep_header_image
add_action( 'ecvetstep_hgroup_wrap', 'ecvetstep_header_image', 10 );