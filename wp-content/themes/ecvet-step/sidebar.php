...
<?php 
/** 
 * ecvetstep_above_secondary hook
 */
do_action( 'ecvetstep_before_secondary' ); ?>
...
<?php 
	...
	if ( $layout == 'left-sidebar' || $layout == 'right-sidebar' || ( $layout == 'default' && $themeoption_layout == 'left-sidebar' ) || ( $layout == 'default' && $themeoption_layout == 'right-sidebar' ) ) { ?>
		...
		<div id="secondary" class="widget-area" role="complementary">
			<?php 
			/** 
			 * ecvetstep_before_widget_start hook
			 */
			do_action( 'ecvetstep_before_widget_start' );
			...
			if ( is_active_sidebar( 'sidebar-1' ) ) {
				...
				<aside id="archives" class="widget">
					<h1 class="widget-title"><?php _e( 'Archives', 'ecvetstep' ); ?></h1>
					<ul>
			...
			<?php 
			/** 
			 * ecvetstep_after_widget_ends hook
			 */
			do_action( 'ecvetstep_after_widget_ends' ); ?>    
...
/** 
 * ecvetstep_after_secondary hook
 */
do_action( 'ecvetstep_after_secondary' );